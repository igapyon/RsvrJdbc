 ...
 * 検索結果の行の更新 の確認。
 */
class RsvrJdbcTest303UpdateByte {
    private static final String CASEID = "test303";

    @Test
    void test303() throws Exception {
        ...
        insertInto(conn, Byte.valueOf("32"));
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                ...
                assertEquals(Byte.valueOf("32"), rset.getByte());

                rset.setColumnIndex(2);
                rset.updateByte(Byte.valueOf("53"));
                rset.updateRow();
            }
        }
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                ...
                assertEquals(Byte.valueOf("53"), rset.getByte());

                rset.setColumnIndex(2);
                rset.updateByte(null);
                rset.updateRow();
            }
        }
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                assertTrue(rset.next());
                assertEquals(null, rset.getByte());
            }
        }
    }
    ...
    void insertInto(Connection conn, Byte value) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
