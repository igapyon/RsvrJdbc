 ...
 * 検索結果の行の更新 の確認。
 */
class RsvrJdbcTest304UpdateShort {
    private static final String CASEID = "test304";

    @Test
    void test304() throws Exception {
        ...
        insertInto(conn, Short.valueOf("321"));
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                ...
                assertEquals(Short.valueOf("321"), rset.getShort());

                rset.setColumnIndex(2);
                rset.updateShort(Short.valueOf("531"));
                rset.updateRow();
            }
        }
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                ...
                assertEquals(Short.valueOf("531"), rset.getShort());

                rset.setColumnIndex(2);
                rset.updateShort(null);
                rset.updateRow();
            }
        }
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                assertTrue(rset.next());
                assertEquals(null, rset.getShort());
            }
        }
    }
    ...
    void insertInto(Connection conn, Short value) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
