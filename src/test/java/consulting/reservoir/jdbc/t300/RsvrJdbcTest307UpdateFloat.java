 ...
 * 検索結果の行の更新 の確認。
 */
class RsvrJdbcTest307UpdateFloat {
    private static final String CASEID = "test307";

    @Test
    void test307() throws Exception {
        ...
        insertInto(conn, Float.valueOf("123.456"));
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                ...
                assertEquals(Float.valueOf("123.456"), rset.getFloat());

                rset.setColumnIndex(2);
                rset.updateFloat(Float.valueOf("987.654"));
                rset.updateRow();
            }
        }
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                ...
                assertEquals(Float.valueOf("987.654"), rset.getFloat());

                rset.setColumnIndex(2);
                rset.updateFloat(null);
                rset.updateRow();
            }
        }
        ...
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                assertTrue(rset.next());
                assertEquals(null, rset.getFloat());
            }
        }
    }
    ...
    void insertInto(Connection conn, Float value) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
