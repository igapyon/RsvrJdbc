 ...
 * String の確認。
 */
class RsvrJdbcTest019NString {
    private static final String CASEID = "test019";

    @Test
    void test019() throws Exception {
    ...
    String selectValue(Connection conn, Long recordId) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
            ...
            try (RsvrResultSet rset = stmt.executeQuery()) {
                ...
                return rset.getNString();
            }
        }
    }

    void update(Connection conn, Long recordId, String value) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
