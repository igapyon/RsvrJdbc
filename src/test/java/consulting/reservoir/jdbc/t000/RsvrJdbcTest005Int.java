 ...
 * Integer の確認。
 */
class RsvrJdbcTest005Int {
    private static final String CASEID = "test005";
    ...
    void test005() throws Exception {
        ...
        // 値その1 (insert)
        final Long recordId = insertInto(conn, Integer.valueOf("12345678"));
        assertEquals(Integer.valueOf("12345678"), selectValue(conn, recordId));

        // 値その2 (update)
        update(conn, recordId, Integer.valueOf("87654321"));
        assertEquals(Integer.valueOf("87654321"), selectValue(conn, recordId));
    ...
    Long insertInto(Connection conn, Integer value) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
    ...
    Integer selectValue(Connection conn, Long recordId) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
    ...
    void update(Connection conn, Long recordId, Integer value) throws SQLException {
        try (RsvrPreparedStatement stmt = RsvrJdbc
