 ...
 * AsciiStream の確認。
 */
class RsvrJdbcTest014AsciiStream {
    private static final String CASEID = "test014";

    @Test
    void test014() throws Exception {
        Connection conn = TestUtil.getConnection(CASEID);
        createTable(conn);

        // 値その1 (insert)
        final String value1 = "ABCDEFG";
